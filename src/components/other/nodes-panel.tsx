import { useDragAndDropStoreActions } from '@/stores/drag-and-drop-store';
import { IconMessage } from '@tabler/icons-react';

export function NodesPanel() {
  const { setType } = useDragAndDropStoreActions();
